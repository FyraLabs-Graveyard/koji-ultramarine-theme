...
def imageTag(name):
    ...
    match name:
        case 'complete':
            return '<i class="fas fa-check"></i> Completed'
        case 'failed':
            return '<i class="fas fa-times"></i> Failed'
        case 'closed':
            return '<i class="fas fa-check"></i> Closed'
        case 'canceled':
            return '<i class="fas fa-minus"></i> Canceled'
        case 'building':
            return '<i class="fas fa-ellipsis-h"></i> Building'
        case 'open':
            return '<i class="fas fa-circle"></i> Open'
        case 'free': # Waiting for builder to pick up task
            return '<i class="fas fa-hourglass-start"></i> Waiting for Builder'
        case 'assigned':
            return '<i class="fas fa-hourglass-half"></i> Assigned'
        case _:
            return name
